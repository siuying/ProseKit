...
/// (1956), as published at http://www.thelastquestion.net/.
///
...
enum TheLastQuestion {
    /// The full story, one element per paragraph (44 paragraphs, ~6.8K characters).
    ...
    /// The full story repeated five times (~220 paragraphs, ~34K characters),
